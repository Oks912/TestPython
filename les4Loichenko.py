...
while True:    # Cтворюємо цикл в якому розмістимо блок команд
    ...
    elif element == "exit":                     #Вихід х программи
        break
    else:
        print("Некоректний ввод. Введіть існуючу команду: add, earliest, latest, longest, shortest, exit:")  # Якщо команда введена не вірно,вивести нагалдування
